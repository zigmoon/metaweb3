...
export default class SMedia_Link implements IScript<Props> {
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    if (props.bnw) {
      link.addComponent(new GLTFShape('f89ab04f-46ef-42ea-912b-b194eb8d2f02/models/twitter_bnw.glb'))
    } else {
      link.addComponent(new GLTFShape('f89ab04f-46ef-42ea-912b-b194eb8d2f02/models/twitter.glb'))
    }
